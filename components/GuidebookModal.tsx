...
const GuidebookModal: React.FC<GuidebookModalProps> = ({ isOpen, onClose, isSheet = false }) => {
    
    const content = (
        <>
            <h2 id="guidebook-title" className="font-cinzel text-2xl md:text-3xl text-[var(--color-text-header)] mb-4 text-glow flex items-center gap-3 flex-shrink-0">
                ...
                <section>
                    <h3 className="font-cinzel text-xl text-[var(--color-primary)] mb-2">Tips Lanjutan</h3>
                     <ul className="list-disc list-inside mt-2 pl-4 space-y-1 text-stone-400">
                        ...
                        <li><strong className="text-stone-300">Gunakan Dasbor Anda:</strong> Panel navigasi adalah sumber daya terpenting Anda. Periksa status karakter, inventaris, misi, dan peta secara teratur.</li>

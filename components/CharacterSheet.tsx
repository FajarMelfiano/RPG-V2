...
const CharacterSheet: React.FC<CharacterSheetProps> = ({ character, onSaveAndExit }) => {
    ...
    return (
    <div className="bg-slate-800/70 rounded-xl shadow-lg border border-slate-700 backdrop-blur-sm p-4 h-full flex flex-col overflow-y-auto">
      ...
      <div className="mb-4 flex-grow min-h-0 flex flex-col">
        <h3 className="font-cinzel text-xl text-amber-300 mb-2 border-b-2 border-slate-700 pb-1">Latar Belakang</h3>
        <p className="text-sm text-slate-300 italic flex-grow overflow-y-auto">
            {backstory}
        </p>
      </div>
